$(document).ready(function() {
    ...
    $('#world-map').vectorMap({map: 'world_mill_en',
        ...
        markers: [
            ...
            {latLng: [8, -66], name: 'XPECTRA-Venezuela'},
            {latLng: [23, -102], name: 'XPECTRA-México'}/*,
             {latLng: [-34.708929, -71.223066], name: 'Chile'},
    ...
    $('#ve-map').vectorMap({map: 've_mill',
        ...
        markers: [
            ...
            {latLng: [8.316647, -62.712863], name: 'XPECTRA-Ciudad Guayana'}/*,
            {latLng: [23, -102], name: 'México'},
